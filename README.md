...
- Clone repo
- `pip install .`
- If testing WASM, clone the WABT (WebAssembly Binary Toolkit) repo. If testing WGSL, build Dawn from source and run via Node. If testing GLSL, ensure you have an OpenGL 4.5 compatible GPU and build the ShaderTrap repository. Add the file paths to `config.json`
